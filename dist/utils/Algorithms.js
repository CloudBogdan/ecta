...
class Algorithms {
     ...
     */
    line(fromX, fromY, toX, toY, pixel) {
     ...
     * @param {(x: number, y: number)=> void} pixel
     */
    ellipse(cx, cy, radiusX, radiusY, pixel) {
     ...
     * @param {(x: number, y: number)=> void} pixel
     */
    strokeEllipse(cx, cy, radiusX, radiusY, pixel) {
        if (radiusY == 0) {
     ...
     * @param {(x: number, y: number)=> void} pixel
     */
    dithering(x, y, width, height, pixel, offsetX, offsetY, size) {
        let rw = width;
        let rh = height;
        let rx = x;
        let ry = y;
